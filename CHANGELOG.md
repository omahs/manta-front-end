...
### Changed
- [\#750](https://github.com/Manta-Network/manta-front-end/pull/750) Improve application performance with granular chunking of the application bundle and dynamic import routes
